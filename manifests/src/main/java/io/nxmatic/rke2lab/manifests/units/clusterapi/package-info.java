 ...
 *
 * <ul>
 *   <li>{@link io.nxmatic.rke2lab.manifests.units.clusterapi.ClusterApiOperatorManifestsUnit} — the
 *       Cluster API operator plus core/infrastructure/control-plane providers.
 *   <li>{@link io.nxmatic.rke2lab.manifests.units.clusterapi.IncusIdentitySecretManifestsUnit} —
 *       the Incus identity secret; reads {@code bootstrapIdentity()} and guards against ephemeral
 *       (smoke-test) synthesis.
 *   <li>{@link io.nxmatic.rke2lab.manifests.units.clusterapi.ImageStateConfigMapManifestsUnit} —
 *       the Stage A → Stage B control-node image identity, surfaced as a ConfigMap.
 * </ul>
 *
 * <p>Registered by {@link io.nxmatic.rke2lab.manifests.domain.ClusterApiDomainRegistrar}.
 *
