 ...
 * io.nxmatic.rke2lab.manifests.node.NodeEnvContext}.
 *
 * <p>This is orthogonal to manifest synthesis. Where {@code ManifestsUnit}s emit K8s/systemd
 * artifacts, {@link io.nxmatic.rke2lab.manifests.node.NodeEnvContributor}s contribute environment
 * facts (identity, networking, storage, …) that the node needs at runtime.
 *
 * <h2>What lives here</h2>
 *
 * <ul>
 *   <li>{@link io.nxmatic.rke2lab.manifests.node.NodeEnvContext} / {@link
 *       io.nxmatic.rke2lab.manifests.node.DefaultNodeEnvContext} — the assembled context.
 *   <li>{@link io.nxmatic.rke2lab.manifests.node.NodeEnvContributor} — the contribution SPI.
