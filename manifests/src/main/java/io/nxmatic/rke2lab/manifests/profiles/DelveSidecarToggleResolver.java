...
public final class DelveSidecarToggleResolver {
  ...
  public static final class Builder {
    private String globalKey = "rke2lab.debug.sidecar.enabled";
    private String domainKeyPrefix = "rke2lab.debug.sidecar.domain.";
    private String layerKeyPrefix = "rke2lab.debug.sidecar.layer.";
