...
public final class RuntimeDaemonsetLayer extends Construct {
    ...
    private void createScriptPolicyConfigMap() {
        ApiObject configMap = new ApiObject(this, "configmap-runtime-daemonset-script-policy",
    ...
    private String readResource(final String resourcePath) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed reading runtime daemonset resource: " + resourcePath, ex);
        }
    }
}