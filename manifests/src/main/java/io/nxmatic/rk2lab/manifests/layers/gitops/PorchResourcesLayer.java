...
public final class PorchResourcesLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("gitops", "porch-resources");
    ...
    private ApiObject createCatalogRepository() {
        ApiObject repository = new ApiObject(
                this,
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("config.porch.kpt.dev|Repository|porch-system|${cluster-name}-catalog"))
                                .build())
                        .build()
        );

        repository.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "deployment", true,
    ...
    private ApiObject createStateRepository() {
        ApiObject repository = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("bioskop-state")
                                .namespace("porch-system")
                                .annotations(packageProfile.packageAnnotations("config.porch.kpt.dev|Repository|porch-system|cluster-name-state"))
                                .build())
                        .build()
        );
        ...
        repository.addJsonPatch(JsonPatch.add("/spec", Map.of(
                ...
                "git", Map.of(
                        "branch", "main",
                        "createBranch", true,
                        "directory", "rke2/bioskop/catalog",
                        "repo", "https://github.com/nxmatic/rke2lab.git",
                        "secretRef", "${github-secret}"
                ),
                "type", "git"
    ...
    private void createNetworkingCiliumPackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
                ...
                Map.of(
                        ...
                        "bgp-peer-asn", "65000",
                        "cluster-id", 0,
                        "cluster-lb-cidr", "10.80.0.64/26",
                        "cluster-name", "bioskop-cluster",
                        "cluster-node-gateway-inetaddr", "10.80.0.1",
                        "cluster-vip-cidr", "10.80.7.0/24",
    ...
    private void createNetworkingEnvoyGatewayPackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
    ...
    private void createHaKubeVipPackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
                ...
                Map.of(
                        "cluster-node-vip-inetaddr", "10.80.7.10",
    ...
    private void createMeshHeadscalePackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
                ...
                Map.of(
                        "cluster-lan-headscale-inetaddr", "192.168.1.193",
                        "cluster-lan-lb-cidr", "192.168.1.192/27",
                        "cluster-name", "bioskop",
                        "cluster-vip-cidr", "10.80.7.0/24",
                        "darwin-host", "bioskop"
                ),
    ...
    private void createMeshTailscalePackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
    ...
    private void createRuntimeFloxPackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
    ...
    private void createStorageOpenebsZfsPackageVariant(final ApiObject catalogRepo, final ApiObject stateRepo) {
        createPackageVariant(
    ...
    private void createPackageVariant(
        ...
        ApiObject packageVariant = new ApiObject(
                this,
                constructId,
                ApiObjectProps.builder()
                        .apiVersion("config.porch.kpt.dev/v1alpha1")
        ...
        packageVariant.addJsonPatch(JsonPatch.add("/spec", Map.of(
                ...
                "pipeline", Map.of(
                        "mutators", List.of(Map.of(
                                "configMap", mutatorConfig,
