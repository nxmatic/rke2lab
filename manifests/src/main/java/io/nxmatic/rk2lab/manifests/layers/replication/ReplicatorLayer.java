...
public final class ReplicatorLayer extends Construct {
    ...
    private ApiObject createClusterRole() {
        ...
        clusterRole.addJsonPatch(JsonPatch.add("/rules", new Object[]{
                Map.of(
                        "apiGroups", new Object[]{""},
                        "resources", new Object[]{"namespaces"},
                        "verbs", new Object[]{"get", "watch", "list"}
                ),
                Map.of(
                        "apiGroups", new Object[]{""},
                        "resources", new Object[]{"secrets", "configmaps", "serviceaccounts"},
                        "verbs", new Object[]{"get", "watch", "list", "create", "update", "patch", "delete"}
                ),
                Map.of(
                        "apiGroups", new Object[]{"rbac.authorization.k8s.io"},
                        "resources", new Object[]{"roles", "rolebindings"},
                        "verbs", new Object[]{"get", "watch", "list", "create", "update", "patch", "delete"}
                )
        }));
    ...
    private void createClusterRoleBinding(final ApiObject clusterRole, final ApiObject serviceAccount) {
        ...
        clusterRoleBinding.addJsonPatch(
                ...
                JsonPatch.add("/subjects", new Object[]{
                        Map.of(
                                "kind", "ServiceAccount",
                                "name", "kubernetes-replicator",
                                "namespace", "kube-system"
                        ...
                        "spec", Map.of(
                                ...
                                "containers", new Object[]{
                                        Map.of(
                                                ...
                                                "livenessProbe", Map.of(
                                                        "httpGet", Map.of("path", "/healthz", "port", "health"),
                                                ...
                                                "readinessProbe", Map.of(
                                                        "httpGet", Map.of("path", "/readyz", "port", "health"),
                                                        "initialDelaySeconds", 60,
                                                        "periodSeconds", 10,
                                                        "timeoutSeconds", 1,
                                                        "successThreshold", 1,
