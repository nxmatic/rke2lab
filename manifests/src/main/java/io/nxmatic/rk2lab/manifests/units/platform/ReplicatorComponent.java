...
public final class ReplicatorComponent extends Construct {
  ...
  public ReplicatorComponent(
      final Construct scope, final String id, final String replicatorVersion) {
    super(scope, id);
