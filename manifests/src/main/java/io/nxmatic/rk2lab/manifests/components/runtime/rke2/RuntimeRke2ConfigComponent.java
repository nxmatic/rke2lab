// @codebase
package io.nxmatic.rk2lab.manifests.components.runtime.rke2;
...
public final class RuntimeRke2ConfigComponent extends Construct {
  ...
  public RuntimeRke2ConfigComponent(final Construct scope, final String id) {
    super(scope, id);
