...
public final class HeadscaleLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("mesh", "headscale");
    ...
    public HeadscaleLayer(final Construct scope, final String id) {
        ...
        ApiObject deploymentHeadscale = createDeploymentHeadscale(
                namespace,
                cmFloxEnv,
                cmHeadscaleConfig,
                cmConfigInitScript,
        ...
        ApiObject bootstrapJob = createBootstrapJob(namespace, saBootstrap, cmHeadscaleEnv, cmFloxEnv, cmBootstrapScript, deploymentHeadscale);
        createDeploymentGateway(namespace, saGateway, cmHeadscaleEnv, cmFloxEnv, cmGatewayScript, bootstrapJob);
        createDaemonsetClient(namespace, saClient, cmHeadscaleEnv, cmFloxEnv, cmClientScripts, bootstrapJob, serviceHeadscale);
    }
        ...
        return new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("|Namespace|default|${headscale-namespace}"))
                                .build())
                        .build()
        );
    }
        ...
        ApiObject serviceAccount = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name(name)
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|ServiceAccount|${headscale-namespace}|" + name))
                                .build())
                        .build()
        );
        ...
        ApiObject role = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|ClusterRole|default|headscale-client"))
                                .build())
                        .build()
        );
        role.addJsonPatch(JsonPatch.add("/rules", List.of(
                Map.of("apiGroups", List.of(""), "resources", List.of("nodes"), "verbs", List.of("get", "list")),
                Map.of("apiGroups", List.of(""), "resources", List.of("secrets"), "verbs", List.of("get", "list", "watch")),
                Map.of("apiGroups", List.of("apps"), "resources", List.of("deployments"), "verbs", List.of("get", "list", "watch"))
        )));
        return role;
    }

    private void createClusterRoleBindingClient(final ApiObject role, final ApiObject serviceAccount) {
        ApiObject roleBinding = new ApiObject(
                this,
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headscale-client")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|ClusterRoleBinding|default|headscale-client"))
                                .build())
                        .build()
        );
        ...
        roleBinding.addJsonPatch(
                JsonPatch.add("/roleRef", Map.of("apiGroup", "rbac.authorization.k8s.io", "kind", "ClusterRole", "name", "headscale-client")),
                JsonPatch.add("/subjects", List.of(Map.of("kind", "ServiceAccount", "name", "headscale-client", "namespace", "headscale-system")))
        );
    }
        ...
        ApiObject role = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|Role|${headscale-namespace}|headscale-bootstrap"))
                                .build())
                        .build()
        );
        role.addDependency(namespace);
        role.addJsonPatch(JsonPatch.add("/rules", List.of(
                Map.of("apiGroups", List.of(""), "resources", List.of("secrets"), "verbs", List.of("get", "create", "update", "patch")),
                Map.of("apiGroups", List.of(""), "resources", List.of("pods"), "verbs", List.of("get", "list", "watch")),
                Map.of("apiGroups", List.of(""), "resources", List.of("pods/exec"), "verbs", List.of("create")),
                Map.of("apiGroups", List.of("apps"), "resources", List.of("deployments"), "verbs", List.of("get", "list", "watch"))
        )));
        return role;
    }

    private void createRoleBindingBootstrap(final ApiObject serviceAccount, final ApiObject role, final ApiObject namespace) {
        ApiObject roleBinding = new ApiObject(
                this,
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headscale-bootstrap")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|RoleBinding|${headscale-namespace}|headscale-bootstrap"))
                                .build())
                        .build()
        );
        ...
        roleBinding.addDependency(role);
        roleBinding.addJsonPatch(
                JsonPatch.add("/roleRef", Map.of("apiGroup", "rbac.authorization.k8s.io", "kind", "Role", "name", "headscale-bootstrap")),
                JsonPatch.add("/subjects", List.of(Map.of("kind", "ServiceAccount", "name", "headscale-bootstrap", "namespace", "headscale-system")))
        );
    }

    private ApiObject createConfigMapFloxEnv(final ApiObject namespace) {
        ApiObject configMap = configMapWithData("flox-env", "|ConfigMap|${headscale-namespace}|flox-env", Map.of());
        ...
        configMap.addJsonPatch(
                ...
                JsonPatch.add("/metadata/annotations/replicator.v1.mittwald.de~1replicate-from", "rke2lab-system/flox-env")
        );
        return configMap;
    }

    private ApiObject createConfigMapHeadscaleConfig(final ApiObject namespace) {
        ApiObject configMap = configMapWithData(
                "headscale-config",
    ...
    private ApiObject createConfigMapHeadscaleEnv(final ApiObject namespace) {
        ApiObject configMap = configMapWithData(
                ...
                Map.of(
                        "CLUSTER_LAN_HEADSCALE_INETADDR", "192.168.1.193",
                        "DARWIN_HOST", "bioskop",
                        "HEADPLANE_NAMESPACE", "${headplane-namespace}",
                        "HEADSCALE_NAMESPACE", "headscale-system",
                        "HEADSCALE_URL", "http://headscale.headscale-system.svc.cluster.local:8080",
                        "RKE2_CLUSTER_NAME", "bioskop",
                        "VIP_NETWORK_CIDR", "10.80.7.0/24"
                )
        );
        configMap.addDependency(namespace);
        return configMap;
    ...
    private ApiObject createLanPolicy() {
        ApiObject policy = new ApiObject(
                this,
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("lan-policy")
                                .annotations(packageProfile.packageAnnotations("cilium.io|CiliumL2AnnouncementPolicy|default|lan-policy"))
                                .build())
                        .build()
        );
        policy.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "interfaces", List.of("^lan0$"),
                "loadBalancerIPs", true,
                "nodeSelector", Map.of(
                        "matchExpressions", List.of(Map.of("key", "node-role.kubernetes.io/control-plane", "operator", "Exists"))
                ),
                "serviceSelector", Map.of(
                        "matchLabels", Map.of("io.cilium/lb-ipam-pool", "lan")
                )
        )));
        return policy;
    }
    ...
    private ApiObject createDeploymentHeadscale(
        ...
        ApiObject deployment = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("apps|Deployment|${headscale-namespace}|headscale"))
                                .build())
                        .build()
        );
        ...
        deployment.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "replicas", 1,
                "selector", Map.of("matchLabels", Map.of("app", "headscale")),
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headscale")),
                                "labels", Map.of("app", "headscale")
                        ),
                        "spec", Map.of(
                                "automountServiceAccountToken", false,
                                "containers", List.of(Map.ofEntries(
                                        Map.entry("name", "headscale"),
                                        Map.entry("image", "flox/empty:1.0.0"),
                                        Map.entry("command", List.of("headscale", "serve")),
                                        Map.entry("envFrom", List.of(Map.of("configMapRef", Map.of("name", "flox-env")))),
                                        Map.entry("livenessProbe", Map.of(
                                                "httpGet", Map.of("path", "/health", "port", "http"),
                                                "initialDelaySeconds", 30,
                                                "periodSeconds", 10
                                        )),
                                        Map.entry("readinessProbe", Map.of(
                                                "httpGet", Map.of("path", "/health", "port", "http"),
                                                "initialDelaySeconds", 10,
                                                "periodSeconds", 5
                                        )),
                                        Map.entry("ports", List.of(
                                        ...
                                        Map.entry("resources", Map.of(
                                                "limits", Map.of("cpu", "500m", "ephemeral-storage", "512Mi", "memory", "512Mi"),
                                                "requests", Map.of("cpu", "100m", "ephemeral-storage", "256Mi", "memory", "128Mi")
                                        )),
                                        Map.entry("volumeMounts", List.of(
                                                Map.of("mountPath", "/etc/headscale/config.yaml", "name", "config", "subPath", "config.yaml"),
                                                Map.of("mountPath", "/etc/headscale/acl.json", "name", "acl", "subPath", "acl.json"),
                                                Map.of("mountPath", "/etc/headscale/derp.yaml", "name", "derp", "subPath", "derp.yaml"),
                                                Map.of("mountPath", "/var/lib/headscale", "name", "data"),
                                                Map.of("mountPath", "/var/run/headscale", "name", "run")
                                        ))
                                )),
                                "initContainers", List.of(Map.of(
                                        "name", "config-init",
                                        "image", "flox/empty:1.0.0",
                                        "command", List.of("/scripts/config-init.sh"),
                                        "volumeMounts", List.of(
                                                Map.of("mountPath", "/scripts", "name", "config-init-script"),
                                                Map.of("mountPath", "/config-source", "name", "config-source", "readOnly", true),
                                                Map.of("mountPath", "/config", "name", "config"),
                                                Map.of("mountPath", "/extra-records-source", "name", "extra-records-source", "readOnly", true),
                                                Map.of("mountPath", "/var/lib/headscale", "name", "data")
                                        )
                                )),
                                "nodeSelector", Map.of("node-role.kubernetes.io/control-plane", "true"),
                                "runtimeClassName", "flox",
                                "volumes", List.of(
                                        Map.of("name", "config-source", "configMap", Map.of("name", "headscale-config")),
                                        Map.of("name", "config", "emptyDir", Map.of()),
                                        Map.of("name", "config-init-script", "configMap", Map.of("defaultMode", 493, "name", "headscale-config-init-script")),
                                        Map.of("name", "extra-records-source", "configMap", Map.of("name", "headscale-extra-records")),
                                        Map.of("name", "acl", "configMap", Map.of("name", "headscale-acl")),
                                        Map.of("name", "derp", "configMap", Map.of("name", "headscale-derp")),
    ...
    private ApiObject createServiceHeadscale(final ApiObject namespace, final ApiObject deployment) {
        ApiObject service = new ApiObject(
                this,
                "service-headscale",
                ApiObjectProps.builder()
                        .apiVersion("v1")
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("|Service|${headscale-namespace}|headscale", Map.of(
                                        "io.cilium/lb-ipam-ips", "192.168.1.193",
                                        "tailscale.com/expose", "true",
                                        "tailscale.com/hostname", "bioskop-headscale"
                                )))
                                .build())
                        .build()
        );
    ...
    private ApiObject createBootstrapJob(
        ...
        ApiObject job = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headscale-bootstrap")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("batch|Job|${headscale-namespace}|headscale-bootstrap"))
                                .build())
                        .build()
        );
        ...
        job.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headscale"))
                        ),
                        "spec", Map.of(
                                "containers", List.of(Map.of(
                                        "name", "bootstrap",
                                        "image", "flox/empty:1.0.0",
                                        "command", List.of("/scripts/bootstrap.sh"),
                                        "envFrom", List.of(
                                                Map.of("configMapRef", Map.of("name", "headscale-env")),
                                                Map.of("configMapRef", Map.of("name", "flox-env"))
                                        ),
                                        "resources", Map.of(
                                                "limits", Map.of("cpu", "250m", "ephemeral-storage", "256Mi", "memory", "256Mi"),
                                                "requests", Map.of("cpu", "50m", "ephemeral-storage", "64Mi", "memory", "64Mi")
                                        ),
                                        "volumeMounts", List.of(Map.of("mountPath", "/scripts", "name", "bootstrap-script", "readOnly", true))
                                )),
                                ...
                                "volumes", List.of(Map.of(
                                        ...
                                        "configMap", Map.of("defaultMode", 493, "name", "headscale-bootstrap-script")
                                ))
                        )
                ),
    ...
    private void createDeploymentGateway(
        ...
        ApiObject deployment = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("apps|Deployment|${headscale-namespace}|headscale-gateway"))
                                .build())
                        .build()
        );
        deployment.addDependency(namespace);
        ...
        deployment.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "replicas", 1,
                "selector", Map.of("matchLabels", Map.of("app", "headscale-gateway")),
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headscale")),
                                "labels", Map.of("app", "headscale-gateway")
                        ...
                        "spec", Map.of(
                                ...
                                "containers", List.of(Map.of(
                                        ...
                                        "image", "flox/empty:1.0.0",
                                        "command", List.of("/scripts/gateway.sh"),
                                        "env", List.of(Map.of(
                                                "name", "TS_AUTHKEY",
                                                "valueFrom", Map.of("secretKeyRef", Map.of("key", "authkey", "name", "headscale-client-auth"))
                                        )),
                                        "envFrom", List.of(
                                                Map.of("configMapRef", Map.of("name", "headscale-env")),
                                                Map.of("configMapRef", Map.of("name", "flox-env"))
                                        ...
                                        "resources", Map.of(
                                                "limits", Map.of("cpu", "200m", "ephemeral-storage", "500Mi", "memory", "256Mi"),
                                                "requests", Map.of("cpu", "50m", "ephemeral-storage", "100Mi", "memory", "64Mi")
                                        ),
                                        "securityContext", Map.of(
                                                "capabilities", Map.of("add", List.of("NET_ADMIN", "NET_RAW")),
                                                "privileged", true
                                        ),
                                        "volumeMounts", List.of(
                                                Map.of("mountPath", "/dev/net/tun", "name", "dev-net-tun"),
                                                Map.of("mountPath", "/var/lib/tailscale", "name", "tailscale-state"),
                                                Map.of("mountPath", "/var/run/tailscale", "name", "tailscale-socket"),
                                                Map.of("mountPath", "/var/secrets", "name", "authkey", "readOnly", true),
                                                Map.of("mountPath", "/scripts", "name", "gateway-script", "readOnly", true)
                                        )
                                )),
                                ...
                                "volumes", List.of(
                                        Map.of("name", "dev-net-tun", "hostPath", Map.of("path", "/dev/net/tun", "type", "CharDevice")),
                                        Map.of("name", "tailscale-state", "hostPath", Map.of("path", "/var/lib/tailscale", "type", "DirectoryOrCreate")),
                                        Map.of("name", "tailscale-socket", "emptyDir", Map.of()),
                                        Map.of("name", "gateway-script", "configMap", Map.of("defaultMode", 493, "name", "headscale-gateway-script")),
                                        Map.of("name", "authkey", "secret", Map.of(
                                                "items", List.of(Map.of("key", "authkey", "path", "authkey")),
    ...
    private void createDaemonsetClient(
        ...
        ApiObject daemonSet = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("apps|DaemonSet|${headscale-namespace}|headscale-client"))
                                .build())
                        .build()
        );
        ...
        daemonSet.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "selector", Map.of("matchLabels", Map.of("app", "headscale-client")),
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headscale")),
                                "labels", Map.of("app", "headscale-client")
                        ...
                        "spec", Map.of(
                                "containers", List.of(Map.of(
                                        "name", "tailscale",
                                        "image", "flox/empty:1.0.0",
                                        "command", List.of("/scripts/tailscale-client.sh"),
                                        "env", List.of(
                                                Map.of("name", "RKE2_NODENAME", "valueFrom", Map.of("fieldRef", Map.of("fieldPath", "spec.nodeName"))),
                                                Map.of("name", "TS_AUTHKEY", "valueFrom", Map.of("secretKeyRef", Map.of("key", "authkey", "name", "headscale-client-auth"))),
                                        ...
                                        "resources", Map.of(
                                                "limits", Map.of("cpu", "200m", "ephemeral-storage", "256Mi", "memory", "256Mi"),
                                                "requests", Map.of("cpu", "50m", "ephemeral-storage", "64Mi", "memory", "64Mi")
                                        ),
                                        "securityContext", Map.of(
                                                "capabilities", Map.of("add", List.of("NET_ADMIN", "NET_RAW")),
                                        ...
                                        "volumeMounts", List.of(
                                                ...
                                                Map.of("mountPath", "/var/run/tailscale", "name", "tailscale-socket"),
                                                Map.of("mountPath", "/var/secrets", "name", "authkey", "readOnly", true),
                                                Map.of("mountPath", "/scripts", "name", "client-scripts", "readOnly", true)
                                        )
                                )),
                                "dnsPolicy", "ClusterFirstWithHostNet",
                                "hostNetwork", true,
                                ...
                                "initContainers", List.of(Map.of(
                                        ...
                                        "image", "flox/empty:1.0.0",
                                        "command", List.of("/scripts/wait-for-headscale.sh"),
                                        "envFrom", List.of(
                                                Map.of("configMapRef", Map.of("name", "headscale-env")),
                                                Map.of("configMapRef", Map.of("name", "flox-env"))
                                        ),
                                        "volumeMounts", List.of(Map.of("mountPath", "/scripts", "name", "client-scripts", "readOnly", true))
                                )),
                                "nodeSelector", Map.of("node-role.kubernetes.io/control-plane", "true"),
                                "runtimeClassName", "flox",
                                ...
                                "volumes", List.of(
                                        ...
                                        Map.of("name", "tailscale-state", "hostPath", Map.of("path", "/var/lib/tailscale", "type", "DirectoryOrCreate")),
                                        Map.of("name", "tailscale-socket", "emptyDir", Map.of()),
                                        Map.of("name", "client-scripts", "configMap", Map.of("defaultMode", 493, "name", "headscale-client-scripts")),
                                        Map.of("name", "authkey", "secret", Map.of(
                                                "items", List.of(Map.of("key", "authkey", "path", "authkey")),
                                                "secretName", "headscale-client-auth"
                                        ))
    ...
    private ApiObject configMapWithData(final String name, final String upstream, final Map<String, String> data) {
