// @codebase
package io.nxmatic.rk2lab.manifests.components.runtime.flox;

import io.nxmatic.rk2lab.manifests.ManifestAnnotations;
import io.nxmatic.rk2lab.manifests.ManifestSynthesisContext;
import io.nxmatic.rk2lab.manifests.components.cluster.ClusterRefs;
import io.nxmatic.rk2lab.manifests.components.mesh.MeshRefs;
import io.nxmatic.rk2lab.manifests.components.runtime.RuntimeRefs;
import io.nxmatic.rk2lab.manifests.components.runtime.daemonset.RuntimeDaemonsetScriptPolicyAssets;
...
public final class FloxRuntimeComponent extends Construct {
  ...
  public FloxRuntimeComponent(final Construct scope, final String id) {
    this(scope, id, null);
  }

  public FloxRuntimeComponent(
