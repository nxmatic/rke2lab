...
public final class ClusterRuntimeNamespaceComponent extends Construct {
  ...
  public ClusterRuntimeNamespaceComponent(final Construct scope, final String id) {
    this(scope, id, null);
  }

  public ClusterRuntimeNamespaceComponent(
    ...
    final ApiObject namespace =
        new ApiObject(
            ...
            ApiObjectProps.builder()
                ...
                .build());
    if (registry != null) {
      registry.publish(ClusterRefs.RUNTIME_SYSTEM_NAMESPACE, namespace);
    }
  }
}
