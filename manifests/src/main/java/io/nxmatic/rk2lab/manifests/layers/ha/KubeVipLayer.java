...
public final class KubeVipLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("ha", "kube-vip");
        ...
        ApiObject namespace = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("kube-vip")
                                .annotations(packageProfile.packageAnnotations("|Namespace|default|${kube-vip-namespace}"))
        ...
        ApiObject serviceAccount = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("kube-vip")
                                .namespace("kube-vip")
                                .annotations(packageProfile.packageAnnotations("|ServiceAccount|${kube-vip-namespace}|kube-vip"))
                                .build())
                        .build()
        );
    ...
    private ApiObject createClusterRole() {
        ...
        clusterRole.addJsonPatch(JsonPatch.add("/rules", List.of(
                Map.of(
                        "apiGroups", List.of(""),
                        "resources", List.of("services", "services/status", "nodes", "endpoints"),
                        "verbs", List.of("list", "get", "watch", "update")
                ),
                Map.of(
                        "apiGroups", List.of("coordination.k8s.io"),
                        "resources", List.of("leases"),
                        "verbs", List.of("list", "get", "watch", "update", "create")
                )
        )));
        ...
        ApiObject clusterRoleBinding = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|ClusterRoleBinding|default|system:kube-vip-binding"))
                                .build())
                        .build()
        );
    ...
    private void createDaemonSet(
        ...
        ApiObject daemonSet = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("apps|DaemonSet|${kube-vip-namespace}|kube-vip-ds"))
                                .build())
                        .build()
        );
        ...
        daemonSet.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "selector", Map.of(
                        "matchLabels", Map.of("name", "kube-vip-ds")
                ),
                "template", Map.of(
                        "metadata", Map.of(
                        ...
                        "spec", Map.of(
                                "affinity", Map.of(
                                        "nodeAffinity", Map.of(
                                                "requiredDuringSchedulingIgnoredDuringExecution", Map.of(
                                                        "nodeSelectorTerms", List.of(
                                                                Map.of("matchExpressions", List.of(Map.of(
                                ...
                                "containers", List.of(Map.of(
                                        ...
                                        "resources", Map.of(
                                                "limits", Map.of("cpu", "100m", "memory", "128Mi"),
                                                "requests", Map.of("cpu", "50m", "memory", "64Mi")
                                        ),
                                        "securityContext", Map.of(
                                                "capabilities", Map.of(
                                                        "add", List.of("NET_ADMIN", "NET_RAW", "SYS_TIME")
                                                )
                                        )
                                )),
                                "hostNetwork", true,
        ...
        ApiObject service = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("|Service|kube-system|control-plane-nodeport"))
                                .build())
                        .build()
        );
