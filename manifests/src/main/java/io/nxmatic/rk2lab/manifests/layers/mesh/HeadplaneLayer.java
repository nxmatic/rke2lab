...
public final class HeadplaneLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("mesh", "headplane");
    ...
    public HeadplaneLayer(final Construct scope, final String id) {
        ...
        ApiObject k8sIntegrationRoleBinding = createK8sIntegrationRoleBinding(serviceAccount, k8sIntegrationRole);
        ApiObject syncJob = createAgentSyncJob(
                serviceAccount,
                envConfigMap,
                syncScriptConfigMap,
        ...
        ApiObject deployment = createDeployment(
                serviceAccount,
                envConfigMap,
                secretsSecret,
                agentAuthSecret,
        ...
        return new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("|ServiceAccount|${headscale-namespace}|headplane"))
                                .build())
                        .build()
        );
    }
        ...
        ApiObject configMap = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headplane-env")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|ConfigMap|${headscale-namespace}|headplane-env"))
                                .build())
                        .build()
        );

        configMap.addJsonPatch(JsonPatch.add("/data", Map.of(
                "HEADPLANE_BASE_URL", "http://headplane.headscale-system.svc.cluster.local:3000",
                "HEADPLANE_COOKIE_SECURE", "false",
                "HEADPLANE_NAMESPACE", "headscale-system",
                "HEADSCALE_NAMESPACE", "headscale-system",
                "HEADSCALE_SERVICE_URL", "http://headscale.headscale-system.svc.cluster.local:8080"
        )));
        ...
        ApiObject configMap = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|ConfigMap|${headscale-namespace}|headplane-agent-sync-script"))
                                .build())
                        .build()
        );
        ...
        ApiObject secret = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|Secret|${headscale-namespace}|headplane-config-tmpl"))
                                .build())
                        .build()
        );

        secret.addJsonPatch(
                JsonPatch.add("/stringData", Map.of(
                        "config.yaml",
                        "server:\n"
                                + "  host: \"0.0.0.0\"\n"
                                + "  port: 3000\n"
        ...
        ApiObject secret = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|Secret|${headscale-namespace}|headplane-secrets"))
                                .build())
                        .build()
        );
    ...
    private ApiObject createAgentAuthSecret() {
        ApiObject secret = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|Secret|${headscale-namespace}|headplane-agent-auth"))
                                .build())
                        .build()
        );
        ...
        secret.addJsonPatch(
                JsonPatch.add("/stringData", Map.of(
                        "preauthkey", "REPLACE_WITH_HEADSCALE_PREAUTH_KEY"
                )),
                JsonPatch.add("/type", "Opaque")
        );
        ...
        ApiObject pvc = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headplane-data")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("|PersistentVolumeClaim|${headscale-namespace}|headplane-data"))
                                .build())
                        .build()
        );

        pvc.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "accessModes", List.of("ReadWriteOnce"),
                "resources", Map.of(
                        "requests", Map.of("storage", "128Mi")
                )
        )));
        ...
        ApiObject role = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|Role|${headscale-namespace}|headplane-agent-sync"))
                                .build())
                        .build()
        );

        role.addJsonPatch(JsonPatch.add("/rules", List.of(Map.of(
                "apiGroups", List.of(""),
                "resources", List.of("secrets"),
                "verbs", List.of("get", "create", "update", "patch")
        ))));

        return role;
    }

    private ApiObject createAgentSyncRoleBinding(final ApiObject serviceAccount, final ApiObject role) {
        ApiObject roleBinding = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headplane-agent-sync")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|RoleBinding|${headscale-namespace}|headplane-agent-sync"))
                                .build())
                        .build()
        );
    ...
    private ApiObject createK8sIntegrationRole() {
        ApiObject role = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|Role|${headscale-namespace}|headplane-k8s-integration"))
                                .build())
                        .build()
        );
        ...
        role.addJsonPatch(JsonPatch.add("/rules", List.of(
                Map.of(
                        "apiGroups", List.of(""),
                        "resources", List.of("pods", "pods/exec"),
                        "verbs", List.of("get", "list", "create")
                ),
                Map.of(
                        "apiGroups", List.of("apps"),
                        "resources", List.of("deployments"),
    ...
    private ApiObject createK8sIntegrationRoleBinding(final ApiObject serviceAccount, final ApiObject role) {
        ApiObject roleBinding = new ApiObject(
                this,
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headplane-k8s-integration")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|RoleBinding|${headscale-namespace}|headplane-k8s-integration"))
                                .build())
                        .build()
        );
    ...
    private ApiObject createAgentSyncJob(
        ...
        ApiObject job = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("headplane-agent-sync")
                                .namespace("headscale-system")
                                .annotations(packageProfile.packageAnnotations("batch|Job|${headscale-namespace}|headplane-agent-sync"))
                                .build())
                        .build()
        );
        ...
        job.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headplane"))
                        ),
                        "spec", Map.of(
                                "containers", List.of(Map.of(
                                        "name", "sync",
                                        "image", "alpine:3.20",
                                        "command", List.of("/bin/sh", "-c", "apk add --no-cache yq kubectl && /scripts/agent-sync.sh"),
                                        "envFrom", List.of(
                                ...
                                "volumes", List.of(
                                        ...
                                        Map.of(
                                                "name", "config-template",
                                                "secret", Map.of("secretName", "headplane-config-tmpl")
                                        ),
                                        Map.of(
                                                "name", "headscale-auth",
                                                "secret", Map.of(
    ...
    private ApiObject createDeployment(
        ...
        ApiObject deployment = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("apps|Deployment|${headscale-namespace}|headplane"))
                                .build())
                        .build()
        );
        ...
        deployment.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "replicas", 1,
                "selector", Map.of("matchLabels", Map.of("app", "headplane")),
                "template", Map.of(
                        "metadata", Map.of(
                                "annotations", packageProfile.templateAnnotations(Map.of("flox.dev/environment", "nxmatic/headplane")),
                                "labels", Map.of("app", "headplane")
                        ...
                        "spec", Map.of(
                                "containers", List.of(Map.ofEntries(
                                        ...
                                        Map.entry("env", List.of(
                                                ...
                                                Map.of(
                                                        ...
                                                        "valueFrom", Map.of(
                                                                "fieldRef", Map.of("fieldPath", "metadata.name")
                                                        )
                                                )
                                        )),
                                        Map.entry("envFrom", List.of(
                                                Map.of("configMapRef", Map.of("name", "headplane-env")),
                                                Map.of("configMapRef", Map.of("name", "flox-env"))
                                        )),
                                        Map.entry("livenessProbe", Map.of(
                                                "exec", Map.of("command", List.of("/usr/libexec/headplane/healthcheck")),
                                                "failureThreshold", 3,
                                        ...
                                        Map.entry("ports", List.of(Map.of("containerPort", 3000, "name", "http"))),
                                        ...
                                        Map.entry("volumeMounts", List.of(
                                                Map.of("mountPath", "/etc/headplane/config.yaml", "name", "config", "subPath", "config.yaml"),
                                                Map.of("mountPath", "/etc/headplane/secrets", "name", "secrets", "readOnly", true),
                                                Map.of("mountPath", "/etc/headplane/agent", "name", "agent", "readOnly", true),
                                                Map.of("mountPath", "/var/lib/headplane", "name", "data"),
                                                Map.of("mountPath", "/etc/headscale", "name", "headscale-config", "readOnly", true),
                                                Map.of("mountPath", "/usr/libexec/headplane", "name", "shared-bin")
                                        ))
                                )),
                                "initContainers", List.of(Map.of(
                                        ...
                                        "volumeMounts", List.of(Map.of(
                                                "mountPath", "/usr/libexec/headplane",
                                                "name", "shared-bin"
                                        ))
                                )),
                                "runtimeClassName", "flox",
                                ...
                                "volumes", List.of(
                                        Map.of("name", "config", "secret", Map.of("secretName", "headplane-config")),
                                        Map.of("name", "secrets", "secret", Map.of("secretName", "headplane-secrets")),
                                        Map.of("name", "agent", "secret", Map.of("secretName", "headplane-agent-auth")),
                                        Map.of("name", "data", "persistentVolumeClaim", Map.of("claimName", "headplane-data")),
                                        Map.of("name", "headscale-config", "configMap", Map.of("name", "headscale-config")),
        ...
        ApiObject service = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("headscale-system")
                                .labels(Map.of("app", "headplane"))
                                .annotations(packageProfile.packageAnnotations("|Service|${headscale-namespace}|headplane"))
                                .build())
                        .build()
        );
    ...
    private void createIngress(final ApiObject service) {
        ApiObject ingress = new ApiObject(
                this,
                "ingress-headplane",
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations(
                                        ...
                                        Map.of(
                                                "io.cilium/lb-ipam-ips", "${cluster-lan-headplane-inetaddr}",
                                                "kubernetes.io/ingress.class", "cilium",
                                                "lab42.io/mdns.enabled", "true",
                                                "lab42.io/mdns.host", "headplane",
                                                "lab42.io/mdns.name", "headplane"
                                        )
                                ))
                                .build())
                        .build()
        ...
        ingress.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "ingressClassName", "cilium",
                "rules", List.of(Map.of(
                        "host", "headplane.local",
                        "http", Map.of(
                                "paths", List.of(Map.of(
                                        "backend", Map.of(
                                                "service", Map.of(
                                                        "name", "headplane",
                                                        "port", Map.of("number", 3000)
                                                )
                                        ),
                                        "path", "/admin",
                                        "pathType", "Prefix"
