...
public final class RuntimeCloudConfigLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("runtime", "cloud-config");
    ...
    private void createCloudConfigManifest() {
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations(
                                        ...
                                        Map.of(
                                                ...
                                                "description.kpt.dev", "Cloud-init NoCloud payload"
                                        )
                                ))
                                .build())
                        .build()
        ...
        configMap.addJsonPatch(JsonPatch.add("/data", Map.of(
                "userData", readResource("/runtime/cloud-config/user-data"),
                "metaData", readResource("/runtime/cloud-config/meta-data"),
                "networkData", readResource("/runtime/cloud-config/network-config")
        )));
    }
    ...
    private String readResource(final String resourcePath) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed reading runtime cloud-config resource: " + resourcePath, ex);
        }
    }
}
