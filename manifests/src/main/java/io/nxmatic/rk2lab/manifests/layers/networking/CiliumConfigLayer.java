...
public final class CiliumConfigLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("networking", "cilium-config");
        ...
        ApiObject helmChartConfig = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("helm.cattle.io|HelmChartConfig|kube-system|rke2-cilium"))
                                .build())
                        .build()
        );

        helmChartConfig.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "valuesContent",
                "installCRDs: true\n"
                        + "bpf:\n"
