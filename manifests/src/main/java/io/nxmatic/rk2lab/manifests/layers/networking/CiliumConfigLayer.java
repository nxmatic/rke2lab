        ...
        JsonPatch.add(
            ...
            Map.of(
                ...
                "installCRDs: true\n"
                    ...
                    + "  refreshPeriod: 30s\n"
                    + "l7Proxy: true\n"
                    + "# routingMode: tunnel mode (vxlan/geneve) fails in LXC/Incus containers\n"
                    + "# with 'protocol not supported' error in route reconciler netlink initialization.\n"
                    + "# Since all control nodes run as containers on the same host, native routing\n"
                    + "# is more efficient and avoids the netlink socket issue.\n"
                    + "routingMode: native\n"
