...
public final class RuntimeEnvConfigLayer extends Construct {
    ...
    private static final List<String> ENV_SECTIONS = List.of(
            "cilium",
            "cluster",
            "config",
            "containerd",
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("runtime", "env-config");
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations(
                                        ...
                                        Map.of(
                                                ...
                                                "description.kpt.dev", "Environment section " + section,
                                                "env.rk2lab.nxmatic.io/section", "section-" + section
                                        )
                                ))
                                .build())
                        .build()
    ...
    private Map<String, String> loadEnvData(final String section) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(input, StandardCharsets.UTF_8))) {
            ...
            throw new IllegalStateException("Failed reading runtime env-config resource: " + resourcePath, ex);
        }
