...
public final class TektonDashboardLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("cicd", "tekton-dashboard");
    ...
    private ApiObject createMiddleware() {
        ApiObject middleware = new ApiObject(
                this,
        ...
        middleware.addJsonPatch(JsonPatch.add("/spec", Map.of(
                "stripPrefix", Map.of("prefixes", List.of("/tekton"))
        )));
        return middleware;
    }
    ...
    private ApiObject createIngress() {
        ...
        ingress.addJsonPatch(JsonPatch.add("/spec", Map.of(
                ...
                "rules", List.of(Map.of(
                        "host", "bioskop-web-proxy.lan",
                        "http", Map.of("paths", List.of(Map.of(
                                "path", "/tekton",
                                "pathType", "Prefix",
                                "backend", Map.of("service", Map.of(
                                        "name", "tekton-dashboard",
                                        "port", Map.of("number", 9097)
                                ))
                        )))
                ))
        )));
