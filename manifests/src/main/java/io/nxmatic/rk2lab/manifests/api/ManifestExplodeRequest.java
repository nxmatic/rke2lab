 ...
 *
 * <p>The "layer" and "package" values come from the {@code kpt.dev/package-layer} and {@code
 * kpt.dev/package-name} annotations the layer code stamps on every emitted resource. The order
 * prefix is determined by kind: {@code 00-} for CustomResourceDefinitions, {@code 01-} for other
 * cluster-scoped resources, {@code 02-} for namespace-scoped resources.
 */
