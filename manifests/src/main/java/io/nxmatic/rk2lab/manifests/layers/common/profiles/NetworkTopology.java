 ...
 * io.nxmatic.rk2lab.manifests.layers.common.ManifestSynthesisContext}. Centralizes the CIDRs and
 * interface names previously templated by kpt setters ({@code ${cluster-cidr}}, {@code
