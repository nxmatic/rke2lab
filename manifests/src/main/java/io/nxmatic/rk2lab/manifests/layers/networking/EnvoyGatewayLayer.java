...
public final class EnvoyGatewayLayer extends Construct {
    ...
    private final PackageMetadataProfile packageProfile = new PackageMetadataProfile("networking", "envoy-gateway");
        ...
        ApiObject clusterRoleBinding = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("rbac.authorization.k8s.io|ClusterRoleBinding|default|envoy-gateway-installer"))
                                .build())
                        .build()
        );
    ...
    private void createGatewayClass() {
        ApiObject gatewayClass = new ApiObject(
                this,
                "gatewayclass-envoy",
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("envoy")
                                .annotations(packageProfile.packageAnnotations("gateway.networking.k8s.io|GatewayClass|default|envoy"))
                                .build())
                        .build()
        );

        gatewayClass.addJsonPatch(JsonPatch.add("/spec", Map.of(
        ...
        return new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .annotations(packageProfile.packageAnnotations("|Namespace|default|${envoy-gateway-namespace}"))
                                .build())
                        .build()
        );
    }
        ...
        ApiObject configMap = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                ...
                                .namespace("envoy-gateway-system")
                                .annotations(packageProfile.packageAnnotations("|ConfigMap|${envoy-gateway-namespace}|envoy-gateway-installer-script"))
                                .build())
                        .build()
        );
        ...
        ApiObject serviceAccount = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("envoy-gateway-installer")
                                .namespace("envoy-gateway-system")
                                .annotations(packageProfile.packageAnnotations("|ServiceAccount|${envoy-gateway-namespace}|envoy-gateway-installer"))
                                .build())
                        .build()
        );
        ...
        ApiObject job = new ApiObject(
                ...
                ApiObjectProps.builder()
                        ...
                        .metadata(ApiObjectMetadata.builder()
                                .name("envoy-gateway-installer")
                                .namespace("envoy-gateway-system")
                                .annotations(packageProfile.packageAnnotations("batch|Job|${envoy-gateway-namespace}|envoy-gateway-installer"))
                                .build())
                        .build()
        );
                ...
                "template", Map.of(
                        ...
                        "spec", Map.of(
                                "containers", List.of(Map.of(
                                        ...
                                        "command", List.of("sh", "/scripts/install.sh"),
                                        "env", List.of(
                                                Map.of("name", "ENVOY_GATEWAY_VERSION", "value", "v1.4.2"),
                                                Map.of("name", "ENVOY_GATEWAY_NAMESPACE", "value", "envoy-gateway-system")
                                        ),
                                        "resources", Map.of(
                                                "limits", Map.of(
                                                        "cpu", "200m",
