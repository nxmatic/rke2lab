...
install -D -m 0644 /build-assets/mesh-headplane-flake.nix "${HOST_ROOT}/srv/host/flox-shim.d/mesh/headplane/flake.nix"
install -D -m 0644 /build-assets/networking-kdns-flake.nix "${HOST_ROOT}/srv/host/flox-shim.d/networking/kdns/flake.nix"
