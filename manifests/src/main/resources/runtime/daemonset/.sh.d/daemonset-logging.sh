...
daemonset::logging:stderr:setup() {
	...
	local script_dir script_base script_trace script_log_dir

	script_dir="$(dirname "${script_path}")"
	script_base="$(basename "${script_path}")"
	script_log_dir="${DAEMONSET_SCRIPT_LOG_DIR:-${script_dir}}"
	script_trace="${script_log_dir%/}/${script_base}.xtrace"
