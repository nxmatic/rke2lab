 ...
 * io.seedmatic.rke2lab.seed.broker.port.RunGate} is read: the host publishes ONE {@link
...
public final class ReadinessBudgetExtension implements BeforeTestExecutionCallback {
   ...
   * bundle registry (the {@link io.seedmatic.rke2lab.seed.broker.port.RunGate} route). A host-flat
