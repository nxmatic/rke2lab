 ...
 * io.seedmatic.rke2lab.seed.broker.port.ReadinessOverrides}, keyed per checkpoint); the {@link
 * ReadinessBudgetExtension} resolves {@code effective = override.orElse(this-default)} and hands
 * the scenario a {@link io.seedmatic.rke2lab.osgi.runtime.readiness.ReadinessBudget}.
 *
