 ...
 * {@link io.nxmatic.rke2lab.osgi.runtime.scenario.engine.container.RunRoleSeed RunRoleSeed}, minus
 * the receiver hop: whoever LAUNCHES seeds the operator's {@code logging:level} knob into the
