...
import io.seedmatic.rke2lab.osgibench.scr.Greeter;
import io.seedmatic.rke2lab.osgibench.scr.GreetingClient;
...
class ScrUnsatisfiedReferenceTest {
  ...
  static final OutOfContainerFrameworkExtension felix =
      OutOfContainerFrameworkExtension.builder()
          .withScr()
          .systemPackages("io.seedmatic.rke2lab.osgibench.scr;version=0.1.0")
