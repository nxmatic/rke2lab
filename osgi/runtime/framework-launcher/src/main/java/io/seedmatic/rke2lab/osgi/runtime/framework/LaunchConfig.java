 ...
 * FrameworkLauncher} derives from the {@link io.seedmatic.rke2lab.osgi.boot.discovery.BootPlan}
 * (e.g. pax-presence from whether the plan carries pax bundles). Two honest knobs:
 *
 * <ul>
