 ...
 * (the {@link FluentTopicRunner} treats every topic uniformly as a {@code Topic<I,O>}). Naming the
 * nature makes a topic's role in the pipeline readable at a glance and guides decomposition.
 *
 * <ul>
 *   <li>{@link #EXECUTION} — does a gesture and produces an output. Most topics; a plain {@code
 *       Topic<I,O>}, no base needed.
 ...
 *   <li>{@link #SUB_PIPELINE} — its body is itself a {@code during/then} chain with its own local
