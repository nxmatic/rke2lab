 ...
 * {@code FIELD_*} strings lacked — because each realm's {@code SeedCodec} maps {@code WireEnum ↔
...
public interface WireEnum {
  ...
  /** The kebab-case wire value placed in a SeedEnvelope payload; the codec (de)serializes on it. */
  String slug();
}
