...
// INSTANCE_DISCIPLINE at WARN: ConsultationNarration#consultedLine is a static helper, listed as a
// visible backlog — drop this annotation to return to the ERROR default once it is an instance.
