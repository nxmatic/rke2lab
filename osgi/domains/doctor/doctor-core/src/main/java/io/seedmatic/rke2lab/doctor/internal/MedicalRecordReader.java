 ...
 * io.seedmatic.rke2lab.seed.broker.port.Cellar}'s {@code visit} {@code SeedEnvelopes} into one
 * {@link Visit} per readable entry — INSIDE the bundle realm, where the {@code doctor.records}
