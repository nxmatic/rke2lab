...
import io.seedmatic.rke2lab.doctor.internal.ConsultationDag;
...
public final class ExactRosterDoctor {
  ...
  private static InterventionLedgerRegistry emptyLedger() {
    return new InterventionLedgerRegistry() {
      @Override
      public io.seedmatic.rke2lab.doctor.contract.InterventionLedger ledger() {
        return io.seedmatic.rke2lab.doctor.contract.InterventionLedger.empty();
      }

      @Override
      public void record(io.seedmatic.rke2lab.doctor.contract.Intervention intervention) {}
    };
  }
