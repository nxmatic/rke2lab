...
import io.seedmatic.rke2lab.doctor.contract.HealthSystem;
...
import io.seedmatic.rke2lab.osgi.runtime.scenario.engine.diagnostic.ScrDiagnostics;
 ...
 * io.seedmatic.rke2lab.doctor.spi.Specialist} + an empty {@link OpaqueCellar} into the registry,
 * SCR collects the specialist into {@code DefaultHealthSystem}'s tier-scoped {@code @Reference}
 * roster, the two Cellar-backed frontier registries activate (satisfying the institution's EHR +
 * ledger references), and an admitted doctor routes a consult to the contributed specialist.
 *
