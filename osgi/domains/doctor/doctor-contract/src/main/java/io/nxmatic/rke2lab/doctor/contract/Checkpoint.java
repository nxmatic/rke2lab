 ...
 * scenario id / {@link io.nxmatic.rke2lab.doctor.contract.ConsultationReport#checkpointId()}) and
...
public enum Checkpoint {
   ...
   * io.nxmatic.rke2lab.doctor.contract.ConsultationReport#checkpointId()} names; unknown → empty.
   */
