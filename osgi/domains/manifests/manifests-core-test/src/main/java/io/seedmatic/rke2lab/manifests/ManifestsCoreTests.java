 ...
 * package, then delegates. Authored in {@code io.seedmatic.rke2lab.manifests} so the in-container
 * run sees manifests-core's package-private actors white-box and reaches its DS @Components through
 * the host's {@code BundleContext}.
 *
