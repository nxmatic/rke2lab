 ...
 * {@link io.nxmatic.rke2lab.manifests.ingress.BumpLevel} gate — the highest release it may bump to
 * right now. Keyed by the typed {@link Component} (not a loose id); discovery is computed OSGi-side
 * by the bumper, never by the passive enum.
 *
