...
public interface ManifestsUnit {
   ...
   * io.seedmatic.rke2lab.manifests.profiles.PackageMetadataProfile}. Defaults to the last segment
   * of {@link #manifestUnitId()} (the common case where id and package coincide); override only
   * when they diverge (e.g. id {@code cluster-api/operator} but package {@code
