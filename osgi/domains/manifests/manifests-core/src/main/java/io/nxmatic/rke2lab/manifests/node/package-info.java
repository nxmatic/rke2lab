// @codebase
/**
 * The node environment context. {@link io.nxmatic.rke2lab.manifests.node.DefaultNodeEnvContext}
 * assembles the run's {@link io.nxmatic.rke2lab.manifests.contract.node.NodeEnvContext} — the
