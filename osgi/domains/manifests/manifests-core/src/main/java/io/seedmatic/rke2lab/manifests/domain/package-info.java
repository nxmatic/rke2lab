 ...
 * ordered list of {@link io.seedmatic.rke2lab.manifests.ManifestsUnit}s.
 *
 * <h2>Pattern</h2>
 *
 * <p>Every registrar implements {@link io.seedmatic.rke2lab.manifests.ManifestsDomainRegistrar} and
 * builds a {@link io.seedmatic.rke2lab.manifests.ManifestsDomain} from catalog-derived IDs and
 * direct unit instantiation:
 *
 * <pre>{@code
 * new ManifestsDomain(
 ...
 * io.seedmatic.rke2lab.manifests.contract.ManifestDomainCatalog}, never string literals — this
