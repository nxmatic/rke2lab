 ...
 * resource under {@code <domain>/<package>/<order>-<kind>-<name>.yml}.
 *
 * <p>The "domain" and "package" values come from the {@code io.seedmatic.rke2lab/domain} and {@code
 * io.seedmatic.rke2lab/package} annotations the domain code stamps on every emitted resource. The
