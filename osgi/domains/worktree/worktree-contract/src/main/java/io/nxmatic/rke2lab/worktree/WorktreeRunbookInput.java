 ...
 * AMBIENT (a {@link io.nxmatic.rke2lab.seed.broker.port.AmendmentContributor} the assembler merges
 * at the {@code worktree} amend door) — the entry-gate {@link GatePolicy} (clean-worktree
