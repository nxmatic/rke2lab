...
class IncusCoreInContainerTest {
  ...
  private static final String MANIFESTS_CORE_BSN = "io.seedmatic.rke2lab.manifests.core";
  private static final String RUNNER_FQN = "io.seedmatic.rke2lab.incus.core.IncusCoreTests";
