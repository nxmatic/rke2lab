...
class BootedRealmDiagnosticTest {
  ...
  void anUnresolvedBundleIsReportedByName() {
    final List<String> v =
        new BootedRealmDiagnostic.Report(List.of("io.nxmatic.rke2lab.doctor"), Map.of())
            .violations();
    assertEquals(List.of("bundle io.nxmatic.rke2lab.doctor did not resolve"), v);
  }
  ...
  void aCoExportWithTheSystemBundleIsReported() {
    final List<String> v =
        new BootedRealmDiagnostic.Report(
                List.of(), Map.of("io.nxmatic.rke2lab.manifests", List.of("org.cdk8s")))
            .violations();
    assertEquals(1, v.size());
    assertTrue(
        v.get(0).startsWith("io.nxmatic.rke2lab.manifests co-exports with the system bundle:"));
  ...
  void unresolvedBundlesAreListedBeforeCoExports() {
    ...
    duplications.put("io.nxmatic.rke2lab.manifests", List.of("org.cdk8s"));
    final List<String> v =
        new BootedRealmDiagnostic.Report(List.of("io.nxmatic.rke2lab.doctor"), duplications)
            .violations();
