...
class ManifestsSynthesisPatternTest {
  ...
  private static final String PHASE = "io/seedmatic/rke2lab/manifests/internal/synthesis/Phase";
  private static final String EXECUTION =
      "io/seedmatic/rke2lab/manifests/internal/synthesis/Phase$Execution";
  private static final String ACC =
      "io/seedmatic/rke2lab/x/Builder"; // written externally → accumulator
  private static final String INPUTS = "io/seedmatic/rke2lab/x/Inputs"; // never externally written
  private static final String PHASE_IMPL = "io/seedmatic/rke2lab/x/MyPhase";
  private static final String OWNER = "io/seedmatic/rke2lab/x/Pipeline";
  ...
  void aBareReadOffTheAccumulatorIsFlagged() {
    ...
    surface.add(
        entry("io/seedmatic/rke2lab/x/Sink", externalWriterOf(ACC))); // marks ACC accumulator
  ...
  void aBareReadOffAnImmutableInputsHolderIsClean() {
    ...
    final List<ResolvedBundle.ClassEntry> surface = new ArrayList<>();
    surface.add(
        entry("io/seedmatic/rke2lab/x/Sink", externalWriterOf(ACC))); // ACC is the accumulator
    surface.add(entry(ACC, holder(ACC)));
