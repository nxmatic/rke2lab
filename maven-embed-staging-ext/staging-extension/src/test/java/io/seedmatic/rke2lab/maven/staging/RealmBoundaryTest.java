...
class RealmBoundaryTest {
  ...
  private static final String FORBIDDEN = "io.seedmatic.rke2lab.doctor.records";
  ...
  void aFlatClassReferencingAForbiddenPackageLeaks() {
    final RealmBoundary gate =
        new RealmBoundary("flat", Set.of(FORBIDDEN), Set.of("io.seedmatic.rke2lab.host"));
    final List<String> v =
        gate.violations(
            "io/seedmatic/rke2lab/host/Policy",
            classReferencing("io/seedmatic/rke2lab/doctor/records/Severity"));
  ...
  void aClassReferencingOnlyItsOwnPackageIsClean() {
    ...
    final List<String> v =
        gate.violations(
            "io/seedmatic/rke2lab/host/Policy",
            classReferencing("io/seedmatic/rke2lab/host/Helper"));
