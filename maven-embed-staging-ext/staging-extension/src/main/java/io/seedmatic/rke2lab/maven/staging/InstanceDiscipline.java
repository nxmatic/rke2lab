...
final class InstanceDiscipline {
   ...
   */
  private static final String EXEMPT = "Lio/seedmatic/rke2lab/domain/annotations/Exempt;";

  private static final String EXEMPT_ALL = "Lio/seedmatic/rke2lab/domain/annotations/ExemptAll;";
