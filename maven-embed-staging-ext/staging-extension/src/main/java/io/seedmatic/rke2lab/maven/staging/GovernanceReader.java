 ...
 * mirror enums — exactly as {@link io.seedmatic.rke2lab.osgi.bnd.EmbedCapability} is a typed view
 * of bnd header strings. An INSTANCE reached from its subject ({@link
 * ResolvedBundle#governance()}), not a static helper — navigable back to the bundle it reads, like
 * the gates themselves.
 */
final class GovernanceReader {

  private static final String GOVERNED_BY = "Lio/seedmatic/rke2lab/domain/annotations/GovernedBy;";
  private static final String GOVERNED_BY_ALL =
      "Lio/seedmatic/rke2lab/domain/annotations/GovernedByAll;";
