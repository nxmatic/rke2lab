...
public record ResolvedBundle(
   ...
   * only OUR code: a type under {@code io.seedmatic.rke2lab.*}. A carrier whose job is to re-export
   * a third-party closure ({@code manifests-cdk8s} exporting {@code org.cdk8s} / {@code
   ...
   */
  public static final String OUR_ROOT = "io.seedmatic.rke2lab";
