...
/**
 * The staging extension's own view of {@code io.nxmatic.rke2lab.domain.annotations.Gate} — the
 * build-time staging laws, each governable to its own {@link EnforcementLevel} per package. Read
...
enum Gate {
  ...
  static Gate fromName(String name) {
