...
public class Network extends com.pulumi.resources.CustomResource {
  ...
  private static NetworkArgs makeArgs(
      @Nullable NetworkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
