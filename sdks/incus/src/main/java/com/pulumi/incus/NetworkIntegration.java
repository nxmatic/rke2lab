...
public class NetworkIntegration extends com.pulumi.resources.CustomResource {
   ...
   */
  public NetworkIntegration(
      java.lang.String name,
      NetworkIntegrationArgs args,
  ...
  private NetworkIntegration(
      ...
      @Nullable NetworkIntegrationState state,
      @Nullable com.pulumi.resources.CustomResourceOptions options) {
    super(
        "incus:index/networkIntegration:NetworkIntegration",
        name,
  ...
  private static NetworkIntegrationArgs makeArgs(
      NetworkIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
   ...
   */
  public static NetworkIntegration get(
      java.lang.String name,
      Output<java.lang.String> id,
      @Nullable NetworkIntegrationState state,
      @Nullable com.pulumi.resources.CustomResourceOptions options) {
