...
public class Instance extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="devices", refs={List.class,InstanceDevice.class}, tree="[0,1]")
     ...
     * 
     */
    @Export(name="files", refs={List.class,InstanceFile.class}, tree="[0,1]")
    ...
    @Export(name="sourceInstance", refs={InstanceSourceInstance.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="waitFors", refs={List.class,InstanceWaitFor.class}, tree="[0,1]")
    ...
    public Instance(java.lang.String name, @Nullable InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("incus:index/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("incus:index/instance:Instance", name, state, makeResourceOptions(options, id), false, Utilities.getPackageRef());
    }
