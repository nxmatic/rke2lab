...
public final class GetNetworkZoneResult {
  ...
  public static final class Builder {
    ...
    public Builder config(Map<String, String> config) {
      if (config == null) {
        throw new MissingRequiredPropertyException("GetNetworkZoneResult", "config");
      }
      this.config = config;
      return this;
    }
    ...
    public Builder description(String description) {
      if (description == null) {
        throw new MissingRequiredPropertyException("GetNetworkZoneResult", "description");
      }
    ...
    public Builder id(String id) {
      if (id == null) {
        throw new MissingRequiredPropertyException("GetNetworkZoneResult", "id");
      }
      this.id = id;
      return this;
    }
    ...
    public Builder name(String name) {
      if (name == null) {
        throw new MissingRequiredPropertyException("GetNetworkZoneResult", "name");
      }
      this.name = name;
      return this;
    }
