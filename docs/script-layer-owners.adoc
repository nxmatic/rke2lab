...
| `networking/envoy-gateway`
| `manifests/src/main/java/io/nxmatic/rke2lab/manifests/layers/networking/EnvoyGatewayLayer.java` (inline ConfigMap data)

| `kdns-dlv.sh`
| `networking/kdns`
| `networking/kdns`
| `manifests/src/main/java/io/nxmatic/rke2lab/manifests/layers/networking/KdnsLayer.java` (inline ConfigMap data)

| `agent-sync.sh`
| `mesh/headplane`
| `mesh/headplane`
| `manifests/src/main/java/io/nxmatic/rke2lab/manifests/layers/mesh/HeadplaneLayer.java` (inline ConfigMap data)

| `config-init.sh`
| `mesh/headscale`
| `mesh/headscale`
| `manifests/src/main/java/io/nxmatic/rke2lab/manifests/layers/mesh/HeadscaleLayer.java` (inline ConfigMap data)
