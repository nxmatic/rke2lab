...
**1. Core Interfaces** (manifests/src/main/java/io/nxmatic/rk2lab/manifests/layers/env/)
...
- ✅ META-INF/services/io.nxmatic.rk2lab.manifests.layers.env.LayerEnvContributor (4 implementations registered)
...
```
manifests/
├── src/main/java/io/nxmatic/rk2lab/manifests/
│   └── layers/
│       ├── env/                          (✅ NEW)
...
└── src/main/resources/
    └── META-INF/services/                (✅ NEW)
        └── io.nxmatic.rk2lab.manifests.layers.env.LayerEnvContributor (4 registrations)

controlplane/
└── src/main/java/io/nxmatic/rk2lab/controlplane/
    └── incus/
