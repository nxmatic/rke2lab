...
- [Config restructuring state](config-restructuring-state.md) — branch refactor/config; Increment 1 (migration to Rke2labConfig DTO + InfraDomain enum + entry-gate BDD) DONE & VERIFIED (18 tests + pulumi preview, commits e1fcc06e→3765e56d); Increment 2 (doctor) NOT started
