...
- [Runbook+doctor state](runbook-doctor-state.md) — feature/runbook-doctor: Increments A-D + BDD-quality pass DONE; DAG chantier has a LOCKED medical-model spec (ExamReport/ConsultationReport/medical-record; Doctor supertype; edge-propagated access). NEXT = layer-2 ConsultationReport. Full spec in plan parallel-floating-corbato.md
