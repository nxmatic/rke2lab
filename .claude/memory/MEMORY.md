...
- [Config restructuring state](config-restructuring-state.md) — branch refactor/config; design spec in wip/; single Rke2labConfig DTO, mandatory=plain+throws/optional=Optional, two catalogs + full registrar contribution, doctor remediation; NOT yet implemented
