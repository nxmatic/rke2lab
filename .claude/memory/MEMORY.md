...
- [Runbook+doctor state](runbook-doctor-state.md) — ACTIVE next chantier on feature/runbook-doctor; spec in wip/spec.adoc, design done/not implemented; doctor core shared with config's "first use case" — OPEN: who builds the core
