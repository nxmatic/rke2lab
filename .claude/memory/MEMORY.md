...
- [Runbook+doctor state](runbook-doctor-state.md) — feature/runbook-doctor: Increments A-D + BDD-quality pass DONE; DAG chantier has a refined medical model (patient=Pulumi stack; Dossier=consultation report; symptom-set; Doctor=generic module; record=reconstructable state). Design in wip/spec.adoc + wip/plan.adoc + wip/pulumi-doctor-integration.adoc (930069c1). NEXT=layer-2 persist; Pulumi fork + T2/T3/T4 open
