...
(dedicated ledger stack, folded) — the open decision is which, see [[intervention-provenance-state]].
The cross-stack capability connects to the user's federated-system vision ([[serviceloader-specialist-spi]],
