...
** bioskop: `+10.80.15.1+` (RKE2_CLUSTER_VIP_GATEWAY_IP)
** alcide: `+10.80.23.1+` (RKE2_CLUSTER_VIP_GATEWAY_IP)
...
cd /var/lib/rke2lab/catalog/ha/kube-vip
...
[source,bash]
----
kpt live destroy /var/lib/rke2lab/catalog/ha/kube-vip
