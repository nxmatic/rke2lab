 ...
 *
 * <p>The "domain" and "package" values come from the {@code io.nxmatic.rke2lab/domain} and {@code
 * io.nxmatic.rke2lab/package} annotations the domain code stamps on every emitted resource. The
