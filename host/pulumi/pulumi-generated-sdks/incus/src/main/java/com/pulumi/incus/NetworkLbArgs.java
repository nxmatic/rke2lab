...
public final class NetworkLbArgs extends com.pulumi.resources.ResourceArgs {

  public static final NetworkLbArgs Empty = new NetworkLbArgs();
  ...
  private NetworkLbArgs() {}

  private NetworkLbArgs(NetworkLbArgs $) {
  ...
  public static Builder builder(NetworkLbArgs defaults) {
  ...
  public static final class Builder {
    ...
    public Builder(NetworkLbArgs defaults) {
      $ = new NetworkLbArgs(Objects.requireNonNull(defaults));
    }
    ...
    public NetworkLbArgs build() {
      if ($.listenAddress == null) {
        throw new MissingRequiredPropertyException("NetworkLbArgs", "listenAddress");
      }
      if ($.network == null) {
        throw new MissingRequiredPropertyException("NetworkLbArgs", "network");
      }
      return $;
    }
  }
