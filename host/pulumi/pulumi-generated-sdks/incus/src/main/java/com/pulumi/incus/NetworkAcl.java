...
public class NetworkAcl extends com.pulumi.resources.CustomResource {
  ...
  @Export(
      name = "egresses",
      refs = {List.class, NetworkAclEgress.class},
      tree = "[0,1]")
  ...
  @Export(
      name = "ingresses",
      refs = {List.class, NetworkAclIngress.class},
      tree = "[0,1]")
  ...
  private NetworkAcl(
      ...
      @Nullable NetworkAclState state,
      @Nullable com.pulumi.resources.CustomResourceOptions options) {
    super(
        "incus:index/networkAcl:NetworkAcl",
        name,
  ...
  private static NetworkAclArgs makeArgs(
      @Nullable NetworkAclArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
