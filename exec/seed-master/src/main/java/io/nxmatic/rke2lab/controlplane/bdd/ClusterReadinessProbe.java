 ...
 * io.nxmatic.rke2lab.world.gateway.port.SymptomKind}). Live plays the scenario with a probe backed
 * by the real {@code ClusterBootstrapReadinessVerifier}; tests inject per-phase fakes — the
