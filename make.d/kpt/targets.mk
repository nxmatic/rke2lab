...
# WARNING: setters.yaml is generated by the render recipe; manual edits are overwritten.
define .kpt.rke2-config.setters.file.content
apiVersion: v1
kind: ConfigMap
metadata:
  # Generated setter values for RKE2 config.yaml.d templates; kpt-set from Makefile variables
  # should be in synch with rke2.d/catalog/runtime/rke2-config/setters.yaml
...
data:
  ...
  node-name: $(NODE_NAME)
  node-kind: $(NODE_KIND)
  rke2-debug: "$(KPT_RKE2_CONFIG_DEBUG)"
  rke2-verbosity: "$(KPT_RKE2_CONFIG_VERBOSITY)"
